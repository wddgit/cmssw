...
TEST_CASE("Test ScitagConfig", "[scitagconfig]") {
  ...
  SECTION("scitagconfig default parameters") {
    ...
    CHECK(scitagConfig->enable() == true);
    CHECK(scitagConfig->productionCase() == false);
    CHECK(scitagConfig->analysisSciTag(edm::SciTagCategory::Primary) == 196664);
    CHECK(scitagConfig->analysisSciTag(edm::SciTagCategory::Embedded) == 196700);
    CHECK(scitagConfig->analysisSciTag(edm::SciTagCategory::PreMixedPileup) == 196704);
    CHECK(scitagConfig->productionSciTag(edm::SciTagCategory::Primary) == 196656);
    CHECK(scitagConfig->productionSciTag(edm::SciTagCategory::Embedded) == 196700);
    CHECK(scitagConfig->productionSciTag(edm::SciTagCategory::PreMixedPileup) == 196704);
  }
  ...
  SECTION("scitagconfig analysis case") {
    ...
    CHECK(scitagConfig->enable() == true);
    CHECK(scitagConfig->productionCase() == false);
    CHECK(scitagConfig->analysisSciTag(edm::SciTagCategory::Primary) == 196612);
    CHECK(scitagConfig->analysisSciTag(edm::SciTagCategory::Embedded) == 196860);
    CHECK(scitagConfig->analysisSciTag(edm::SciTagCategory::PreMixedPileup) == 196705);
    CHECK(scitagConfig->productionSciTag(edm::SciTagCategory::Primary) == 396656);
    CHECK(scitagConfig->productionSciTag(edm::SciTagCategory::Embedded) == 396700);
    CHECK(scitagConfig->productionSciTag(edm::SciTagCategory::PreMixedPileup) == 396704);

    std::string pfn1 = "root://example.com//store/data/file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Primary, pfn1);
    CHECK(pfn1 == "root://example.com//store/data/file.root?scitag.flow=196612");

    std::string pfn2 = "root://example.com//store/data/file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Embedded, pfn2);
    CHECK(pfn2 == "root://example.com//store/data/file.root?scitag.flow=196860");

    std::string pfn3 = "root://example.com//store/data/file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::PreMixedPileup, pfn3);
    CHECK(pfn3 == "root://example.com//store/data/file.root?scitag.flow=196705");

    std::string pfn4 = "root://example.com//store/data/file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Undefined, pfn4);
    CHECK(pfn4 == "root://example.com//store/data/file.root");

    std::string pfn5 = "file://example.com//store/data/file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Primary, pfn5);
    CHECK(pfn5 == "file://example.com//store/data/file.root");

    std::string pfn6 = "file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Primary, pfn6);
    CHECK(pfn6 == "file.root");

    std::string pfn7 = "root://example.com//store/data/file.root?eos.app=cmst0";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Primary, pfn7);
    ...
    CHECK_THROWS(scitagConfig->appendScitagToURL(static_cast<edm::SciTagCategory>(4), pfn8));
  }
  ...
  SECTION("scitagconfig production case") {
    ...
    CHECK(scitagConfig->productionCase() == true);
  ...
  SECTION("scitagconfig enable is false") {
    ...
    CHECK(scitagConfig->enable() == false);

    std::string pfn = "root://example.com//store/data/file.root";
    scitagConfig->appendScitagToURL(edm::SciTagCategory::Primary, pfn);
    CHECK(pfn == "root://example.com//store/data/file.root");
  }

  SECTION("scitagconfig out of range case") {
    edm::ParameterSet pset = defaultPSet;
    ...
    std::string pfn1 = "root://example.com//store/data/file.root";
    CHECK_THROWS(scitagConfig->appendScitagToURL(edm::SciTagCategory::Primary, pfn1));

    std::string pfn2 = "root://example.com//store/data/file.root";
    CHECK_THROWS(scitagConfig->appendScitagToURL(edm::SciTagCategory::Embedded, pfn2));
  }
}
