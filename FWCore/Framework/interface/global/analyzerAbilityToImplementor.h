  ...
  namespace global {
    namespace analyzer {
      ...
      struct AbilityToImplementor<edm::InputProcessBlockCache<Cs...>> {
        typedef edm::global::impl::InputProcessBlockCacheHolder<edm::global::EDAnalyzerBase, Cs...> Type;
      };
      ...
      struct AbilityToImplementor<edm::WatchProcessBlock> {
        typedef edm::global::impl::WatchProcessBlock<edm::global::EDAnalyzerBase> Type;
      };
    }  // namespace analyzer
  }    // namespace global
}  // namespace edm
