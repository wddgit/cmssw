...
namespace edm {
  ...
  StreamSchedule::StreamSchedule(
    ...
    for (auto const& worker : allWorkersLumisAndEvents()) {
      ...
      // The new worker pointers will be null for the TriggerResultsInserter, PathStatusInserter, and EndPathStatusInserter.
      // We could add special code to create workers for those, but instead we skip them because they do not have
      // beginStream, endStream, or run/lumi begin/end stream transition functions.
